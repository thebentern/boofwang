...
<template>
  <div class="mx-auto" style="max-width: 1040px; padding: 22px 16px 48px">
    <div class="flex items-center gap-2.5 flex-wrap" style="margin-bottom: 11px">
      ...
      <span v-if="codeplug.isOpen && count" class="ms-auto" style="font-size: 12px; color: var(--mu)">
    ...
    <template v-else>
      <p style="font-size: 11.5px; color: var(--mu); line-height: 1.6; max-width: 78ch; margin-bottom: 12px">
